...
print(f"Lista convertida a tupla: {tupla_numeros}")# Se definen con parentesis () y pueden contener cualquier tipo de elementos, incluso otras tuplas, o colecciones.
# Son ordenadas (sus elementos tienen indices) y son inmutables (no se pueden agregar, eliminar o modificar)
